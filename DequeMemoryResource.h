...
#include "utils/log2.h"                 // utils::ceil_log2
#include <array>
...
class DequeMemoryResource
{
 ...
 public:
  ...
  // before using the first std::deque that uses memory::DequeAllocator.
  //
  // For example,
  //
  // memory::MemoryPagePool mpp(0x8000);                         // Allocate 32kB at a time.
